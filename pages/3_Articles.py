...
img_ms = Image.open("images/Multiple_sclerosis.jpg")
img_ms1 = Image.open("images/multiple-sclerosis.jpg")
img_heart = Image.open("images/heart.jpg")
img_asthma = Image.open("images/asthma.jpg")
...
with st.container():
    ...
    with left_column:
        ...
        st.write("[Learn More](https://www.mayoclinic.org/diseases-conditions/multiple-sclerosis/symptoms-causes/syc-20350269)")
    with right_column:
        st.image(img_ms)
        st.image(img_ms1)
...
with st.container():
    ...
    with right_column:
        ...
        st.write("[Learn More](https://www.mayoclinic.org/diseases-conditions/asthma/symptoms-causes/syc-20369653#:~:text=Asthma%20is%20a%20condition%20in,asthma%20is%20a%20minor%20nuisance.)")
